                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <g:link controller="subscription" action="delete" params="${[topicId:trendingTopics.id]}">Unsubscribe</g:link>
                                    </g:if>
                                    <g:else>
                                        <g:link controller="subscription" action="save" params="${[topicId:trendingTopics.id]}">Subscribe</g:link>
                                    </g:else>
                                </div>
