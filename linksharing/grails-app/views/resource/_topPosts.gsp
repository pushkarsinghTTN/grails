        ...
        <g:each in="${resource.Resource.getTopPost()}" var="topPosts">
            <div class="col-lg-12">
                ...
                <div class="col-lg-9">
                    ...
                    <p>${topPosts.createdBy.getName()}
                        <span
                                style="color: darkgray">@${topPosts.createdBy.username}</span><span
                            class="pull-right"
                            style="margin-right: 0px;color: #007efc;font-size: small"><a
                                href="${createLink(controller: 'topic', action: 'show', id: topPosts.topic.id)}">${topPosts.topic.name}</a>
                    </span>
                    </p>

                    <p>${topPosts.description}</p>
                    ...
                    <span class="pull-right" style="margin-right: 0px;color: #007efc">
                        <a href="${createLink(controller:'resource',action:'show',id:topPosts.id)}">View Post</a>
